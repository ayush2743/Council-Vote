...
import { Clock, CheckCircle, Shield, BarChart3, ChevronRight, Zap } from 'lucide-react-native';
...
export default function AdminDashboardScreen() {
  ...
  const loadData = async () => {
    ...
    if (!pendingRes.error && pendingRes.data) {
      ...
      const positions = (pendingRes.data as any).positions || pendingRes.data;
      setPendingCount(Array.isArray(positions) ? positions.length : 0);
    }
  ...
  return (
    <View style={{ flex: 1, backgroundColor: COLORS.background }}>
      ...
      <StatCard
        ...
        onPress={() => router.push('/(tabs)/admin-positions')}
      />
      ...
      >
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push('/(tabs)/admin-moderators')}
        >
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push('/(tabs)/admin-results')}
        >
